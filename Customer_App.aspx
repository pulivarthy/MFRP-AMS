...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row form-group">
            ...
            <div class="col-sm-4">
               ...
               <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidatorZipCode" runat="server" ErrorMessage="Invalid Format" ValidationExpression="([0-9]{6})"></asp:RegularExpressionValidator>--%>
            </div>
            <div class="col-sm-1"></div>
        </div>
    <div class="row form-group">
    ...
    <div class="row form-group">
            ...
            <div class="col-sm-3">
                <asp:Button ID="btnsubmit" runat="server" Text="submit" OnClick="btnsubmit_Click"/> <asp:Button ID="btnReset" runat="server" Text="Reset" />
            </div>
            <div class="col-sm-4">
